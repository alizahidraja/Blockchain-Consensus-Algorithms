...
func main() {
	...
	*/
    ...
    if len(os.Args) == 2 { //Satoshi
        ...
        for {
            ...
            if i == 1 { //Transaction
                ...
                err = gobEncoder.Encode(Transaction {
                    ind, amount, j, pool.Miners[miner], tranfee, pool
                })
        ...
        person: = & Person {
            os.Args[1], 100, os.Args[2], os.Args[3], os.Args[4], os.Args[5]
        }
        ...
        for {
            ...
            if i == 1 { //Transaction
                ...
                gobEncoder: = gob.NewEncoder(conn)
                err = gobEncoder.Encode(Transaction {
                    ind, amount, j, miner, tranfee, pool
                })
